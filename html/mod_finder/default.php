...
$input = '<input type="text" name="q" id="mod-finder-searchword' . $module->id . '" class="js-finder-search-query form-control uk-search-input" value="' . htmlspecialchars($app->input->get('q', '', 'string'), ENT_COMPAT, 'UTF-8') . '"'
...
<form class="mod-finder js-finder-searchform form-search uk-search uk-search-default" action="<?php echo Route::_($route); ?>" method="get" role="search">

	<span uk-search-icon></span> <?php echo $output; ?>
