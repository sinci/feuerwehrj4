		...
		<fieldset>
			...
			<?php foreach ($this->extraButtons as $button):
				...
				<div class="com-users-login__submit control-group">
					<div class="controls">
						<button type="button"
								class="btn btn-secondary w-100 uk-button uk-button-default <?php echo $button['class'] ?? '' ?>"
			...
			<div class="com-users-login__submit control-group">
				<div class="controls">
					<button type="submit" class="btn btn-primary uk-button uk-button-secondary uk-margin-small-top">
