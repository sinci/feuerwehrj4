...
<form id="login-form-<?php echo $module->id; ?>" class="mod-login" action="<?php echo Route::_('index.php', true); ?>" method="post">
	...
	<div class="mod-login__userdata userdata">
		...
		<div class="mod-login__password form-group">
			<?php if (!$params->get('usetext', 0)) : ?>
				<div class="input-group">
					<input id="modlgn-passwd-<?php echo $module->id; ?>" type="password" name="password" autocomplete="current-password" class="form-control uk-input" placeholder="<?php echo Text::_('JGLOBAL_PASSWORD'); ?>">
			...
			<div class="mod-login__twofactor form-group">
				<?php if (!$params->get('usetext', 0)) : ?>
					<div class="input-group">
						...
						<input id="modlgn-secretkey-<?php echo $module->id; ?>" autocomplete="one-time-code" type="text" name="secretkey" class="form-control uk-input" placeholder="<?php echo Text::_('JGLOBAL_SECRETKEY'); ?>">
						<span class="input-group-text">
		...
		<?php foreach($extraButtons as $button):
			...
			<div class="mod-login__submit form-group">
				<button type="button"
						class="btn btn-secondary w-100 mt-4 uk-button uk-button-secondary <?php echo $button['class'] ?? '' ?>"
		...
		<div class="mod-login__submit form-group">
			<button type="submit" name="Submit" class="uk-button uk-button-secondary uk-margin-small-top"><?php echo Text::_('JLOGIN'); ?></button>
		</div>
