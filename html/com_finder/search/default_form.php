	...
	<fieldset class="com-finder__search word mb-3">
		...
		<div class="form-inline">
			...
			<div class="input-group">
				...
				<button type="submit" class="btn btn-primary uk-button uk-button-default">
					<span class="icon-search icon-white" aria-hidden="true"></span>
					<?php echo Text::_('JSEARCH_FILTER_SUBMIT'); ?>
				</button>
				<?php if ($this->params->get('show_advanced', 1)) : ?>
					<?php HTMLHelper::_('bootstrap.collapse'); ?>
					<button class="btn btn-secondary uk-button uk-button-default" type="button" data-bs-toggle="collapse" data-bs-target="#advancedSearch" aria-expanded="<?php echo ($this->params->get('expand_advanced', 0) ? 'true' : 'false'); ?>">
	...
	<?php if ($this->params->get('show_advanced', 1)) : ?>
		<fieldset id="advancedSearch" class="com-finder__advanced js-finder-advanced collapse<?php if ($this->params->get('expand_advanced', 0)) echo ' show'; ?>">
			...
			<?php if ($this->params->get('show_advanced_tips', 1)) : ?>
				<div class="com-finder__tips card card-outline-secondary">
					<div class="card-body">
			...
			<?php endif; ?>
			<div id="finder-filter-window" class="com-finder__filter mb-3">
