...
$doc->addStyleSheet(Uri::root() . 'templates/feuerwehrj4/css/custom.css');
	...
	<div class="uk-container uk-margin-top uk-margin-bottom">
		<?php if ($this->error->getCode() === 404) : ?>
			<div class="uk-text-center uk-padding-large">
				<h1 class="uk-heading-large uk-text-primary" style="font-size: 8rem; line-height: 1;">404</h1>
				...
				<div class="uk-margin-medium-top">
					<a href="<?php echo $this->baseurl; ?>/" class="uk-button uk-button-primary uk-margin-small-right">
						<span uk-icon="home"></span> Zur Startseite
					</a>
					<a href="javascript:history.back()" class="uk-button uk-button-default">
						<span uk-icon="arrow-left"></span> Zurück
					</a>
				</div>
			</div>
		<?php else : ?>
